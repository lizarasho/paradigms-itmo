...
(def Sinh
  (create-operation 'sinh (fn [x] (Math/sinh x)) (fn [this var] (Multiply (Cosh (operand-at this 0)) (diff-of var this 0)))
                    ))
(def Cosh
  (create-operation 'cosh (fn [x] (Math/cosh x)) (fn [this var] (Multiply (Sinh (operand-at this 0)) (diff-of var this 0)))
                    ))
(def Square
  (create-operation 'square (fn [x] (* x x))
                    (fn [this var] (Multiply (Constant 2) (operand-at this 0) (diff-of var this 0)))))

(def Sqrt
  (create-operation 'sqrt (fn [x] (Math/sqrt (Math/abs x)))
                    (fn [this var] (Multiply (Sqrt (Square (operand-at this 0)))
                                             (diff-of var this 0)
                                             (Divide ONE (Multiply (operand-at this 0)
                                                                   TWO
                                                                   (Sqrt (operand-at this 0))))))))
