    ...
    private void readToken() throws ParsingException {
        ...
        if (isEnd()) {
            ...
            if (bracketsCounter != 0) {
                throw new IllegalParenthesisException("no closing parenthesis");
            }
            return;
        }
        ...
        switch (symbol) {
            ...
            case ')': {
                ...
                bracketsCounter--;
                if (bracketsCounter < 0) {
                    throw new IllegalParenthesisException("no opening parenthesis");
                }
            ...
            default: {
                if (Character.isDigit(symbol)) {
                    ...
                    if (!number.equals("0") && !number.equals("1")) {
                        throw new IllegalNumberException(number, expression, curPointer - number.length() + 1);
                    }
